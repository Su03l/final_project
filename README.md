...
```bash
export smart_life_organizer_KEY=value
export smart_life_organizer_KEY="@int 42"
export smart_life_organizer_KEY="@jinja {{ this.db.uri }}"
export smart_life_organizer_DB__uri="@jinja {{ this.db.uri | replace('db', 'data') }}"
```
...
```bash
smart_life_organizer_ENV=production smart_life_organizer run
```
