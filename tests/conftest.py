...
# WARNING: Ensure imports from `smart_life_organizer` comes after this line
from smart_life_organizer import app, settings, db  # noqa
from smart_life_organizer.cli import create_user, cli  # noqa
